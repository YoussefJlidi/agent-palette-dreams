        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-card border border-border rounded-xl p-6 animate-fade-in" style={{animationDelay: '0.1s'}}>
              ...
              <h3 className="text-xl font-semibold mb-3">Recrutement d'agents commerciaux</h3>
            ...
            <div className="bg-card border border-border rounded-xl p-6 animate-fade-in" style={{animationDelay: '0.2s'}}>
              ...
              <h3 className="text-xl font-semibold mb-3">Formation et développement</h3>
              <p className="text-foreground/70">
            ...
            <div className="bg-card border border-border rounded-xl p-6 animate-fade-in" style={{animationDelay: '0.4s'}}>
              ...
              <h3 className="text-xl font-semibold mb-3">Coaching personnalisé</h3>
              <p className="text-foreground/70">
                Accompagnement individuel de vos commerciaux pour développer leur potentiel et surmonter les obstacles spécifiques.
              </p>
            </div>
            
            <div className="bg-card border border-border rounded-xl p-6 animate-fade-in" style={{animationDelay: '0.5s'}}>
              <div className="h-12 w-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                <svg className="h-6 w-6 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3">Stratégie commerciale</h3>
              <p className="text-foreground/70">
                Élaboration et mise en œuvre de stratégies commerciales innovantes pour conquérir de nouveaux marchés.
              </p>
            </div>
            
            <div className="bg-card border border-border rounded-xl p-6 animate-fade-in" style={{animationDelay: '0.6s'}}>
              <div className="h-12 w-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                <svg className="h-6 w-6 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-3">Automatisation commerciale</h3>
              <p className="text-foreground/70">
